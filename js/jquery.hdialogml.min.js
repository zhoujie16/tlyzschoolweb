...
b+"px;height:"+c+"px;line-height:"+c+"px;border-radius:4px;background:rgba(0,0,0,0.6);color:#ccc;text-align:center;position:fixed;top:50%;left:50%;margin:"+f+';">'+a+'<a style="position:absolute;top:-5px;right:-5px;width:15px;height:15px;line-height:15px;display:inline-block;border-radius:50%;text-align:center;background-color:rgba(0,0,0,0.5);color:#fff;font-size:10px;" href="javascript:;" id="closeBtn">X</a></div>');d("#closeBtn").on("click",function(){d.hideLoading()})},hideLoading:function(){methods.remove("#HLoading")},
tooltip:function(a,b,c,d){a=void 0!=a?a:"Error...";b=void 0!=b?parseInt(b):2500;var e='<div class="HTooltip shake animated" style="width:280px;padding:10px;text-align:center;background-color:#D84C31;color:#ccc;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+a+"</div>";1==c&&void 0!=c&&(e='<div class="HTooltip bounceInDown animated" style="width:280px;padding:10px;text-align:center;background-color:#5cb85c;color:#ccc;position:fixed;top:10px;left:50%;z-index:100001;margin-left:-150px;box-shadow:1px 1px 5px #333;-webkit-box-shadow:1px 1px 5px #333;">'+
